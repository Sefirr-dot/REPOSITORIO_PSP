...
public class ProcessTercerPrincipalExecutor {
	...
	public static void main(String[] args) throws IOException, InterruptedException {
		...
		Process processTr = new ProcessBuilder("java","ejercicico1.TransformaString")
				.redirectErrorStream(true).directory(path).start();	
		Process processEx = new ProcessBuilder("java","ejercicico1.ExportarAFile",FILE.toString())
				.redirectErrorStream(true).directory(path).start();
